...
final class EnregistrerPhotoIntervention {
  const EnregistrerPhotoIntervention(this._repository);
  ...
  Future<CompteRenduIntervention> call({
    ...
    return _repository.enregistrerPhoto(interventionId, sourcePath);
  }
}
